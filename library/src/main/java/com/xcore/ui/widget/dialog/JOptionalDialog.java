 ...
 * version: 1.0.0
 */
public class JOptionalDialog extends DialogFragment implements OnClickListener {

    private static JOptionalDialog dialog;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_jh_optional, container, false);
    }
     ...
     * @param mCallback     回调
     */
    public static JOptionalDialog show(FragmentActivity act, String mContentStr, String mokBtnStr, String mCancelBtnStr, JDialogCallback mCallback) {
     ...
     * @param mCallback   回调
     */
    public static JOptionalDialog show(FragmentActivity act, String mContentStr, JDialogCallback mCallback) {
        contentStr = mContentStr;
