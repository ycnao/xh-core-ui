...
import com.xzero.core.libs.utils.ResourceUtils;
import com.xzero.core.ui.widget.view.RotateGestureDetector;


/**
 * Created by chenyen on 2016/12/30.
 */
public class PhotoView extends AppCompatImageView {
    ...
    private final RotateGestureDetector.OnRotateListener mRotateListener = new RotateGestureDetector.OnRotateListener() {
...
//            onUp(e2);
    ...
    public static class Info {
        ...
        public Info(RectF rect, RectF img, RectF widget, RectF base, PointF screenCenter, float scale, float degrees, ScaleType scaleType) {
            mRect.set(rect);
            mImgRect.set(img);
